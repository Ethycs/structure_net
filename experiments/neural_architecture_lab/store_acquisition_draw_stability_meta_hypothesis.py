#!/usr/bin/env python3
"""Store the preregistered TinyLLM acquisition-draw stability result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-acquisition-draw-stability-v1.json"
        ),
    )
    ...
    record = store_acquisition_draw_stability_meta_hypothesis(
        args.results,
        args.output,
