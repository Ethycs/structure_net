#!/usr/bin/env python3
"""Store the TinyLLM attention-head defect result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument("--results", type=Path, default=Path("data/experiments/tinyllm_attention_head_defect/20260806_d6_preregistered/campaign_results.json"))
    parser.add_argument("--output", type=Path, default=Path("data/meta_hypotheses/tinyllm-attention-head-defect-sparsity-v1.json"))
    ...
    record = store_attention_head_defect_meta_hypothesis(
        args.results,
        args.output,
