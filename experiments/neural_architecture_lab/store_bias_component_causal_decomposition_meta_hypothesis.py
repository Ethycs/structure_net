#!/usr/bin/env python3
"""Store the TinyLLM frozen bias-component causal result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-bias-component-causal-decomposition-v1.json"
        ),
    )
    ...
    record = store_bias_component_causal_decomposition_meta_hypothesis(
        args.results,
        args.output,
