#!/usr/bin/env python3
"""Store the TinyLLM block-1 quotient-control campaign in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-block1-horizontal-vertical-control-v1.json"
        ),
    )
    ...
    record = store_block1_quotient_control_meta_hypothesis(
        args.results,
        args.output,
