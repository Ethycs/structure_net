#!/usr/bin/env python3
"""Store the TinyLLM held-out C2 attention-head result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument("--results", type=Path, default=Path("data/experiments/tinyllm_c2_attention_head_decomposition/20260806_d6_preregistered/campaign_results.json"))
    parser.add_argument("--output", type=Path, default=Path("data/meta_hypotheses/tinyllm-c2-sparse-attention-head-synthesis-v1.json"))
    ...
    record = store_c2_attention_head_decomposition_meta_hypothesis(
        args.results,
        args.output,
