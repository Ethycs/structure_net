#!/usr/bin/env python3
"""Store the exact C3 charged-character corrective result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-charged-character-fixed-decoder-corrective-v1.json"
        ),
    )
    ...
    record = store_c3_charged_character_fixed_decoder_meta_hypothesis(
        args.results,
        args.output,
