#!/usr/bin/env python3
"""Store the C3 constant-acceleration fixed-operator result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-constant-acceleration-fixed-operator-v1.json"
        ),
    )
    ...
    record = store_c3_constant_acceleration_fixed_operator_meta_hypothesis(
        args.results,
        args.output,
