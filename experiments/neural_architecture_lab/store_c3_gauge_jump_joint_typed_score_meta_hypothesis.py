#!/usr/bin/env python3
"""Store the fresh C3 gauge-jump joint typed-score result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-gauge-jump-joint-typed-score-v1.json"
        ),
    )
    ...
    record = store_c3_gauge_jump_joint_typed_score_meta_hypothesis(
        args.results,
        args.output,
