#!/usr/bin/env python3
"""Store the C3 hidden-order corruption fixed-estimator result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            "data/experiments/"
            "tinyllm_c3_hidden_order_corruption_fixed_estimator/"
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-hidden-order-corruption-fixed-estimator-v1.json"
        ),
    )
    ...
    record = store_c3_hidden_order_corruption_fixed_estimator_meta_hypothesis(
        args.results,
        args.output,
