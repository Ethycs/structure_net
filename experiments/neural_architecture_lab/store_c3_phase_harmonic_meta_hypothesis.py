#!/usr/bin/env python3
"""Store the TinyLLM C3 phase-harmonic result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument("--results", type=Path, default=Path("data/experiments/tinyllm_c3_phase_harmonic/20260806_d6_preregistered/campaign_results.json"))
    parser.add_argument("--output", type=Path, default=Path("data/meta_hypotheses/tinyllm-c3-phase-harmonic-fusion-v1.json"))
    ...
    record = store_c3_phase_harmonic_meta_hypothesis(
        args.results,
        args.output,
