#!/usr/bin/env python3
"""Store the observed C3 relational-connection preflight result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-relational-connection-preflight-v1.json"
        ),
    )
    ...
    record = store_c3_relational_connection_preflight_meta_hypothesis(
        args.results,
        args.output,
