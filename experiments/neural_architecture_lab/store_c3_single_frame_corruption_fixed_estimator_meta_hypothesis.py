#!/usr/bin/env python3
"""Store the C3 single-frame-corruption fixed-estimator result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            "data/experiments/"
            "tinyllm_c3_single_frame_corruption_fixed_estimator/"
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-single-frame-corruption-fixed-estimator-v1.json"
        ),
    )
    ...
    record = store_c3_single_frame_corruption_fixed_estimator_meta_hypothesis(
        args.results,
        args.output,
