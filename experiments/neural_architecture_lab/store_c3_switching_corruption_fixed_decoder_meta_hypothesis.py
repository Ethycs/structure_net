#!/usr/bin/env python3
"""Store the C3 switching-corruption fixed-decoder result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-switching-corruption-fixed-decoder-v1.json"
        ),
    )
    ...
    record = store_c3_switching_corruption_fixed_decoder_meta_hypothesis(
        args.results,
        args.output,
