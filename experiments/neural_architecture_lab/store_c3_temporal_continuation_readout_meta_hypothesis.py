#!/usr/bin/env python3
"""Store the frozen C3 temporal continuation/readout result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-temporal-continuation-readout-v1.json"
        ),
    )
    ...
    record = store_c3_temporal_continuation_readout_meta_hypothesis(
        args.results,
        args.output,
