#!/usr/bin/env python3
"""Store the C3 temporal feature-trajectory causal result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-temporal-feature-trajectory-causal-v1.json"
        ),
    )
    ...
    record = store_c3_temporal_feature_trajectory_causal_meta_hypothesis(
        args.results,
        args.output,
