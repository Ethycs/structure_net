#!/usr/bin/env python3
"""Store the C3 temporal fixed-operator ceiling result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-temporal-fixed-operator-ceiling-v1.json"
        ),
    )
    ...
    record = store_c3_temporal_fixed_operator_ceiling_meta_hypothesis(
        args.results,
        args.output,
