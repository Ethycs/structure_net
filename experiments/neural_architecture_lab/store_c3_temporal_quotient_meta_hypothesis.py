#!/usr/bin/env python3
"""Store the TinyLLM observable-C3 temporal quotient result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-temporal-quotient-training-v1.json"
        ),
    )
    ...
    record = store_c3_temporal_quotient_meta_hypothesis(
        args.results,
        args.output,
