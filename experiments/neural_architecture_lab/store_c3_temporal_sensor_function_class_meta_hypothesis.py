#!/usr/bin/env python3
"""Store the C3 temporal sensor function-class preflight evidence."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c3-temporal-sensor-function-class-v1.json"
        ),
    )
    ...
    record = store_c3_temporal_sensor_function_class_meta_hypothesis(
        args.results,
        args.output,
