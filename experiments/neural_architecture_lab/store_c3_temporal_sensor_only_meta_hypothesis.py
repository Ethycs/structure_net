#!/usr/bin/env python3
"""Store the five-seed C3 temporal sensor-only result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-c3-temporal-sensor-only-v1.json"
        ),
    )
    ...
    record = store_c3_temporal_sensor_only_meta_hypothesis(
        args.results,
        args.output,
