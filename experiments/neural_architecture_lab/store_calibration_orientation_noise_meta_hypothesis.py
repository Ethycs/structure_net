#!/usr/bin/env python3
"""Store the TinyLLM calibration-orientation noise result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-calibrated-orientation-noise-radius-v1.json"
        ),
    )
    ...
    record = store_calibration_orientation_noise_meta_hypothesis(
        args.results,
        args.output,
