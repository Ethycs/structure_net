#!/usr/bin/env python3
"""Store the TinyLLM calibration readout-decomposition result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-calibration-readout-decomposition-v1.json"
        ),
    )
    ...
    record = store_calibration_readout_decomposition_meta_hypothesis(
        args.results,
        args.output,
