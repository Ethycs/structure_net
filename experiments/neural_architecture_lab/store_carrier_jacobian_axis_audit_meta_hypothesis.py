#!/usr/bin/env python3
"""Store the TinyLLM carrier-Jacobian axis-audit result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-c2-carrier-jacobian-axis-audit-v1.json"
        ),
    )
    ...
    record = store_carrier_jacobian_axis_audit_meta_hypothesis(
        args.results,
        args.output,
