#!/usr/bin/env python3
"""Store the TinyLLM conditional branch-depth campaign in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-joint-depth-internal-cosine-quotient-v1.json"
        ),
    )
    ...
    record = store_conditional_branch_depth_meta_hypothesis(
        args.results,
        args.output,
