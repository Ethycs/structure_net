#!/usr/bin/env python3
"""Store the TinyLLM cross-seed causal-carrier transport result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c2-cross-seed-causal-carrier-transport-v1.json"
        ),
    )
    ...
    record = store_cross_seed_causal_carrier_transport_meta_hypothesis(
        args.results,
        args.output,
