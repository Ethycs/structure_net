#!/usr/bin/env python3
"""Store the TinyLLM decoder-boundary basis result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument("--results", type=Path, default=Path("data/experiments/tinyllm_defect_boundary_basis/20260806_d6_preregistered/campaign_results.json"))
    parser.add_argument("--output", type=Path, default=Path("data/meta_hypotheses/tinyllm-c2-defect-boundary-basis-v1.json"))
    ...
    record = store_defect_boundary_basis_meta_hypothesis(
        args.results,
        args.output,
