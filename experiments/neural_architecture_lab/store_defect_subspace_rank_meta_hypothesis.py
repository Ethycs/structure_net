#!/usr/bin/env python3
"""Store the TinyLLM defect-subspace rank result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument("--results", type=Path, default=Path("data/experiments/tinyllm_defect_subspace_rank/20260806_d6_preregistered/campaign_results.json"))
    parser.add_argument("--output", type=Path, default=Path("data/meta_hypotheses/tinyllm-c2-defect-subspace-rank-v1.json"))
    ...
    record = store_defect_subspace_rank_meta_hypothesis(
        args.results,
        args.output,
