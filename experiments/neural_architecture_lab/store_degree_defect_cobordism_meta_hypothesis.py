#!/usr/bin/env python3
"""Store the TinyLLM degree/defect cobordism result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-degree-change-equals-indexed-defect-charge-v1.json"
        ),
    )
    ...
    record = store_degree_defect_cobordism_meta_hypothesis(
        args.results,
        args.output,
