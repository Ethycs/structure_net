#!/usr/bin/env python3
"""Store the TinyLLM final-query Jensen decomposition result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-final-query-jensen-decomposition-v1.json"
        ),
    )
    ...
    record = store_final_query_jensen_decomposition_meta_hypothesis(
        args.results,
        args.output,
