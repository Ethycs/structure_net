#!/usr/bin/env python3
"""Store the TinyLLM final-query task/kernel result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-final-query-task-kernel-barycenter-v1.json"
        ),
    )
    ...
    record = store_final_query_task_kernel_meta_hypothesis(
        args.results,
        args.output,
