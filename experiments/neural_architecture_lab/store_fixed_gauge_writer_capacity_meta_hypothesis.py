#!/usr/bin/env python3
"""Store the TinyLLM fixed-gauge writer-capacity result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-c2-fixed-gauge-writer-capacity-v1.json"
        ),
    )
    ...
    record = store_fixed_gauge_writer_capacity_meta_hypothesis(
        args.results,
        args.output,
