#!/usr/bin/env python3
"""Store the TinyLLM frozen cyclic answer-projection result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-frozen-cyclic-answer-projection-v1.json"
        ),
    )
    ...
    record = store_frozen_cyclic_answer_projection_meta_hypothesis(
        args.results,
        args.output,
