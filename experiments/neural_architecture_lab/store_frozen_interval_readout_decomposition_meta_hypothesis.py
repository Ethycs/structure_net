#!/usr/bin/env python3
"""Store the TinyLLM frozen interval-readout population result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-frozen-interval-readout-decomposition-v1.json"
        ),
    )
    ...
    record = store_frozen_interval_readout_decomposition_meta_hypothesis(
        args.results,
        args.output,
