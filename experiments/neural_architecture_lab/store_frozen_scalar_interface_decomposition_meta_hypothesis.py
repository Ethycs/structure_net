#!/usr/bin/env python3
"""Store the TinyLLM frozen scalar-interface diagnostic."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-frozen-scalar-interface-decomposition-v1.json"
        ),
    )
    ...
    record = store_frozen_scalar_interface_decomposition_meta_hypothesis(
        args.results,
        args.output,
