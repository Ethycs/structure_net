#!/usr/bin/env python3
"""Store the TinyLLM group/task-metric carrier-transport result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c2-group-task-metric-carrier-transport-v1.json"
        ),
    )
    ...
    record = store_group_task_metric_transport_meta_hypothesis(
        args.results,
        args.output,
