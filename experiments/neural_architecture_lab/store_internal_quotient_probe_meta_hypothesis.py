#!/usr/bin/env python3
"""Store the TinyLLM frozen internal-quotient probe in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-internal-cosine-quotient-erases-branch-v1.json"
        ),
    )
    ...
    record = store_internal_quotient_probe_meta_hypothesis(
        args.results,
        args.output,
