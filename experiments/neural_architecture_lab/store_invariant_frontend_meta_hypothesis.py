#!/usr/bin/env python3
"""Store the TinyLLM invariant-front-end campaign in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-invariant-frontend-stable-cosine-quotient-v1.json"
        ),
    )
    ...
    record = store_invariant_frontend_meta_hypothesis(
        args.results,
        args.output,
