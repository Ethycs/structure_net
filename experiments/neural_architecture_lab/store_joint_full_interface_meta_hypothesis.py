#!/usr/bin/env python3
"""Store the TinyLLM joint full-interface physical-typing result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-joint-full-interface-physical-typing-v1.json"
        ),
    )
    ...
    record = store_joint_full_interface_meta_hypothesis(
        args.results,
        args.output,
