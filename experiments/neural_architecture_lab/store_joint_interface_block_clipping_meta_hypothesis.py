#!/usr/bin/env python3
"""Store the TinyLLM parameter-block clipping result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-joint-interface-block-clipping-v1.json"
        ),
    )
    ...
    record = store_joint_interface_block_clipping_meta_hypothesis(
        args.results,
        args.output,
