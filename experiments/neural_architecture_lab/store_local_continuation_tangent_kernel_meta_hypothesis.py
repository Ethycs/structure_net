#!/usr/bin/env python3
"""Store the TinyLLM local continuation tangent/kernel result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c2-local-continuation-tangent-kernel-v1.json"
        ),
    )
    ...
    record = store_local_continuation_meta_hypothesis(
        args.results,
        args.output,
