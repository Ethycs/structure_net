#!/usr/bin/env python3
"""Store the TinyLLM local metric-field transport result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c2-local-metric-field-transport-v1.json"
        ),
    )
    ...
    record = store_local_metric_field_transport_meta_hypothesis(
        args.results,
        args.output,
