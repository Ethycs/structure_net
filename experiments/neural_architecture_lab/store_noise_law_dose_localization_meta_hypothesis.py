#!/usr/bin/env python3
"""Store the TinyLLM sensor-noise dose-localization result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-noise-law-dose-localization-v1.json"
        ),
    )
    ...
    record = store_noise_law_dose_localization_meta_hypothesis(
        args.results,
        args.output,
