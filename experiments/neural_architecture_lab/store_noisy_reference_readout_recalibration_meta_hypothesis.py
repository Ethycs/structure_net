#!/usr/bin/env python3
"""Store the TinyLLM noisy-reference readout-recalibration result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-noisy-reference-readout-recalibration-v1.json"
        ),
    )
    ...
    record = store_noisy_reference_readout_recalibration_meta_hypothesis(
        args.results,
        args.output,
