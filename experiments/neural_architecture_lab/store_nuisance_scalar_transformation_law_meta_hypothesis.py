#!/usr/bin/env python3
"""Store the TinyLLM nuisance-scalar transformation-law result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c2-nuisance-scalar-transformation-law-v1.json"
        ),
    )
    ...
    record = store_nuisance_scalar_transformation_law_meta_hypothesis(
        args.results,
        args.output,
