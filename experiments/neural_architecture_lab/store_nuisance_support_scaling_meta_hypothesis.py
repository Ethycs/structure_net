#!/usr/bin/env python3
"""Store the primary TinyLLM nuisance-support campaign in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-nuisance-invariant-internal-cosine-quotient-v1.json"
        ),
    )
    ...
    record = store_nuisance_support_scaling_meta_hypothesis(
        args.results,
        args.output,
