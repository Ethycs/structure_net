#!/usr/bin/env python3
"""Store the preregistered TinyLLM observed cyclic-deck result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-observed-cyclic-deck-twirl-front-v1.json"
        ),
    )
    ...
    record = store_observed_cyclic_deck_meta_hypothesis(
        args.results,
        args.output,
