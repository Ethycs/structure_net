#!/usr/bin/env python3
"""Store the preregistered TinyLLM observed-deck twirl result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-observed-deck-twirl-causal-closure-v1.json"
        ),
    )
    ...
    record = store_observed_deck_twirl_meta_hypothesis(
        args.results,
        args.output,
