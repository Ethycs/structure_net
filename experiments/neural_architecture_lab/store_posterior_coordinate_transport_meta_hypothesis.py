#!/usr/bin/env python3
"""Store the TinyLLM posterior-coordinate transport result."""
...
from neural_architecture_lab.posterior_coordinate_transport_meta_hypothesis import (
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-posterior-coordinate-transport-v1.json"
        ),
    )
    ...
    record = store_posterior_coordinate_transport_meta_hypothesis(
        args.results,
        args.output,
