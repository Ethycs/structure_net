#!/usr/bin/env python3
"""Store the TinyLLM predictive-circle campaign in the NAL evidence ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-semantic-quotient-circle-v1.json"
        ),
    )
    ...
    record = store_predictive_circle_meta_hypothesis(
        args.results,
        args.output,
