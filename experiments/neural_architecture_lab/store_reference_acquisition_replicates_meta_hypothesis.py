#!/usr/bin/env python3
"""Store the TinyLLM repeated-reference acquisition result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-reference-acquisition-replicates-v1.json"
        ),
    )
    ...
    record = store_reference_acquisition_replicates_meta_hypothesis(
        args.results,
        args.output,
