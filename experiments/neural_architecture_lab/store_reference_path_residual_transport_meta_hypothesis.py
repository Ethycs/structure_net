#!/usr/bin/env python3
"""Store the TinyLLM reference-path residual-transport result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-reference-path-residual-transport-v1.json"
        ),
    )
    ...
    record = store_reference_path_residual_transport_meta_hypothesis(
        args.results,
        args.output,
