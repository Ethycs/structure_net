#!/usr/bin/env python3
"""Store the corrective TinyLLM repeated-reference result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-repeated-reference-acquisition-v1.json"
        ),
    )
    ...
    record = store_repeated_reference_acquisition_meta_hypothesis(
        args.results,
        args.output,
