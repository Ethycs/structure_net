#!/usr/bin/env python3
"""Store the TinyLLM Reynolds character-coupling result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument("--results", type=Path, default=Path("data/experiments/tinyllm_reynolds_character_coupling/20260806_d6_preregistered/campaign_results.json"))
    parser.add_argument("--output", type=Path, default=Path("data/meta_hypotheses/tinyllm-reynolds-character-coupling-synthesis-v1.json"))
    ...
    record = store_reynolds_character_coupling_meta_hypothesis(
