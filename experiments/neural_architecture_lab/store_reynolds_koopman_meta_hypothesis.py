#!/usr/bin/env python3
"""Store the TinyLLM Reynolds–Koopman result in the NAL ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--results",
        type=Path,
        default=Path("data/experiments/tinyllm_reynolds_koopman/20260806_d6_preregistered/campaign_results.json"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/meta_hypotheses/tinyllm-reynolds-koopman-quotient-closure-v1.json"),
    )
    ...
    record = store_reynolds_koopman_meta_hypothesis(
        args.results,
        args.output,
