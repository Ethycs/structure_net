#!/usr/bin/env python3
"""Store the TinyLLM task-activation scalar-sensor result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-c2-task-activation-scalar-sensor-v2.json"
        ),
    )
    ...
    record = store_task_activation_scalar_sensor_meta_hypothesis(
        args.results,
        args.output,
