#!/usr/bin/env python3
"""Store the TinyLLM task-quotient contrast in the NAL evidence ledger."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/meta_hypotheses/tinyllm-task-topology-follows-quotient-v1.json"
        ),
    )
    ...
    record = store_task_quotient_contrast_meta_hypothesis(
        args.results,
        args.output,
