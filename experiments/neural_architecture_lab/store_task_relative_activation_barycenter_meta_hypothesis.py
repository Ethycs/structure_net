#!/usr/bin/env python3
"""Store the TinyLLM task-relative activation barycenter result."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "tinyllm-task-relative-activation-barycenter-v1.json"
        ),
    )
    ...
    record = store_task_relative_activation_barycenter_meta_hypothesis(
        args.results,
        args.output,
