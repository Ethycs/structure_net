...
SCHEMA_VERSION = "nal.tinyllm-c2-task-activation-scalar-sensor.v2"
...
FRESH_COHORT_SEEDS = {"composition": 630_007, "extrapolation": 630_008}
SYSTEMS_COHORT = "systems_f"
SYSTEMS_COHORT_SEEDS = {"composition": 730_007, "extrapolation": 730_008}
...
def _evidence_role(config: TaskActivationScalarSensorConfig) -> str:
    return (
        ...
        else "preregistered_fresh_e_corrective_underpowered_mechanistic_evidence"
    )


def _evaluation_cohort(config: TaskActivationScalarSensorConfig) -> str:
    return SYSTEMS_COHORT if config.allow_underpowered else FRESH_COHORT


def _evaluation_seeds(
    config: TaskActivationScalarSensorConfig,
) -> dict[str, int]:
    return SYSTEMS_COHORT_SEEDS if config.allow_underpowered else FRESH_COHORT_SEEDS
...
def _fresh_cell(
    ...
    cell["cohort"] = cohort
    cell["evaluation_seed"] = evaluation_seed
    return cell
...
def _fingerprint(
    ...
    payload = {
        ...
        "evaluation_cohort": _evaluation_cohort(config),
...
def run_campaign(
    ...
    """Run the locked cohort-E corrective without changing the v1 history."""
    ...
    for seed in config.seeds:
        ...
        for regime in fixed.REGIMES:
            ...
            control_seed = 115_000_000 + 100_003 * seed + evaluation_seeds[regime]
            ...
            fresh_records.append(
                {
                    ...
                    "regime": regime,
                    "evaluation_seed": evaluation_seeds[regime],
                    "oracle_audit": oracle_audit,
    ...
    campaign = {
        ...
        "method_boundaries": [
            "The frozen task covector deliberately retains its oracle quotient-phase chart so this corrective isolates only the scalar sensor.",
