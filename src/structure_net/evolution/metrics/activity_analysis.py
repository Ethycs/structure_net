...
class ActivityAnalyzer(BaseMetricAnalyzer, StatisticalUtilsMixin):
    ...
    def __init__(self, threshold_config):
        raise DeprecationWarning(
            ...
            "- structure_net.components.metrics.NeuronActivityMetric for basic activity metrics\n"
            "- structure_net.components.metrics.ActivationDistributionMetric for distribution analysis\n"
            "- structure_net.components.metrics.ActivityPatternMetric for pattern analysis\n"
            "- structure_net.components.metrics.LayerHealthMetric for health scoring\n"
            "- structure_net.components.analyzers.ActivityAnalyzer for combined analysis\n"
            "\nExample migration:\n"
            "# Old code:\n"
            ...
            "\n"
            "# New code:\n"
            "from structure_net.components.analyzers import ActivityAnalyzer\n"
