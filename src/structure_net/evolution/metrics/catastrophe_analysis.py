...
class CatastropheAnalyzer(BaseMetricAnalyzer):
    ...
    - structure_net.components.metrics.ActivationStabilityMetric
    - structure_net.components.metrics.LyapunovMetric
    - structure_net.components.metrics.TransitionEntropyMetric
    - structure_net.components.analyzers.CatastropheAnalyzer
    """
    ...
    def __init__(self, model, threshold_config=None):
        raise DeprecationWarning(
            ...
            "Please use the following components instead:\n"
            "- For activation stability: structure_net.components.metrics.ActivationStabilityMetric\n"
            "- For Lyapunov analysis: structure_net.components.metrics.LyapunovMetric\n"
            "- For transition entropy: structure_net.components.metrics.TransitionEntropyMetric\n"
            "- For comprehensive analysis: structure_net.components.analyzers.CatastropheAnalyzer\n"
            "\nExample migration:\n"
            "# Old:\n"
            ...
            "\n"
            "# New:\n"
            "from structure_net.components.analyzers import CatastropheAnalyzer\n"
