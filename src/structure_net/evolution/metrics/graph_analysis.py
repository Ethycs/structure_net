...
class GraphAnalyzer(BaseMetricAnalyzer, NetworkAnalyzerMixin):
    ...
    def __init__(self, network: nn.Module, threshold_config):
        raise DeprecationWarning(
            ...
            "- structure_net.components.metrics.GraphStructureMetric for graph building and basic metrics\n"
            "- structure_net.components.metrics.CentralityMetric for centrality analysis\n"
            "- structure_net.components.metrics.SpectralGraphMetric for spectral properties\n"
            "- structure_net.components.metrics.PathAnalysisMetric for path analysis\n"
            "- structure_net.components.analyzers.GraphAnalyzer for combined analysis\n"
            "\nExample migration:\n"
            "# Old code:\n"
            ...
            "\n"
            "# New code:\n"
            "from structure_net.components.analyzers import GraphAnalyzer\n"
