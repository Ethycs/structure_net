...
class HomologicalAnalyzer(BaseMetricAnalyzer, NetworkAnalyzerMixin, StatisticalUtilsMixin):
    ...
    - Metrics (low-level measurements):
      * structure_net.components.metrics.ChainComplexMetric
      * structure_net.components.metrics.RankMetric
      * structure_net.components.metrics.BettiNumberMetric
      * structure_net.components.metrics.HomologyMetric
      * structure_net.components.metrics.InformationEfficiencyMetric
    
    - Analyzer (high-level analysis):
      * structure_net.components.analyzers.HomologicalAnalyzer
    ...
    Example migration:
        ...
        # New way:
        from structure_net.components.analyzers import HomologicalAnalyzer
    ...
    def __init__(self, threshold_config=None, tolerance: float = 1e-6):
        raise DeprecationWarning(
            ...
            "Use structure_net.components.analyzers.HomologicalAnalyzer for full analysis\n"
            "or individual metrics from structure_net.components.metrics for specific measurements.\n"
