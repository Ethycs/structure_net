...
class SensitivityAnalyzer(BaseMetricAnalyzer, NetworkAnalyzerMixin):
    ...
    def __init__(self, network: nn.Module, threshold_config):
        raise DeprecationWarning(
            ...
            "- structure_net.components.metrics.GradientSensitivityMetric for gradient-based sensitivity\n"
            "- structure_net.components.metrics.BottleneckMetric for bottleneck detection\n"
            "- structure_net.components.analyzers.SensitivityAnalyzer for combined analysis\n"
            "\nExample migration:\n"
            "# Old code:\n"
            ...
            "\n"
            "# New code:\n"
            "from structure_net.components.analyzers import SensitivityAnalyzer\n"
