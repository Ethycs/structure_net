...
class TopologicalAnalyzer(BaseMetricAnalyzer, NetworkAnalyzerMixin, StatisticalUtilsMixin):
    ...
    def __init__(self, threshold_config=None, patch_size: int = 8, min_density: float = 0.15):
        raise DeprecationWarning(
            ...
            "- structure_net.components.metrics.ExtremaMetric for extrema detection\n"
            "- structure_net.components.metrics.PersistenceMetric for persistence analysis\n"
            "- structure_net.components.metrics.ConnectivityMetric for connectivity patterns\n"
            "- structure_net.components.metrics.TopologicalSignatureMetric for signatures\n"
            "- structure_net.components.analyzers.TopologicalAnalyzer for combined analysis\n"
            "\nExample migration:\n"
            "# Old code:\n"
            ...
            "\n"
            "# New code:\n"
            "from structure_net.components.analyzers import TopologicalAnalyzer\n"
            "analyzer = TopologicalAnalyzer(patch_size=8)\n"
